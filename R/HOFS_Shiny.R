HOFS_Shiny <- function( data, label, C = 0.2, Nfeatures = 10, samplePct = 0.1, verbose = T, seed = 666 ){
  ...
  withProgress(message = "Selection process", detail = sprintf("1 out of %s", Nfeatures), value = 0, {
  ...
  while( s < N & s < Nfeatures ){
    ...
    incProgress( 1/Nfeatures, detail = sprintf("%s out of %s", s, Nfeatures))
  }
